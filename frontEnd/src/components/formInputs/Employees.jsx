...
const EmployeesFormInputs = ({ handleBlur, handleChange, values, touched,
  errors, isEdit, dataIdName, dataOfficeIdName, jobTitleList, setFieldValue,
  employeesSchema }) => {
...
export default EmployeesFormInputs;
